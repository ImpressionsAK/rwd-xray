    ...
    with open(os.path.join(sys.path[0], "user.bin"), "rb+") as f:
        ...
        if input_bin_hash == '79b695a73fd5ff22cbfeb4b83908ab29': #CR-V thanks to joe1
            ...
            data_new = [
                ...
                '0x0000, 0x0500, 0x0980, 0x0D80, 0x0FCD, 0x1180, 0x1200, 0x2D00, 0x3600', # new torque_table row 1
                '0x0000, 0x034D, 0x07CD, 0x0C00, 0x0F00, 0x1080, 0x1200, 0x2D00, 0x3600', # new torque_table row 2
                '0x0000, 0x034D, 0x07CD, 0x0C00, 0x0ECC, 0x1066, 0x1200, 0x2D00, 0x3600', # new torque_table row 3
                '0x0000, 0x0400, 0x0680, 0x0980, 0x0CD5, 0x1000, 0x1200, 0x2D00, 0x3600', # new torque_table row 4
                '0x0000, 0x039A, 0x0726, 0x0AEF, 0x0E9A, 0x10E6, 0x1200, 0x2D00, 0x3600', # new torque_table row 5
                '0x0000, 0x0746, 0x0B04, 0x0CDF, 0x0E19, 0x1008, 0x1200, 0x2D00, 0x3600', # new torque_table row 6
                '0x0000, 0x06B3, 0x0B1A, 0x0CCD, 0x0E9A, 0x104D, 0x1CB8, 0x2923, 0x358E', # new torque_table row 7
